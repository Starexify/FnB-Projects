            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="https://modrinth.com/collection/Z8kWlmg3" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                            <svg class="size-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 514 514">
                        ...
                        <a href="https://www.curseforge.com/members/imverybad/projects" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                            <svg class="size-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://www.reddit.com/r/Foxirions_Forge" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                            <svg class="size-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 30 30">
